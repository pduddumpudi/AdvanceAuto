...
st.markdown(
    ...
    <style>
    .stApp {
        margin-top: -70px;  /* Adjust this value to remove white space */
    }
    </style>
    """,
...
# Update table layout
fig.update_layout(width=1300, height=125, title=dict(text='Part Details', font=dict(size=20, family='sans-serif')), margin=dict(t=30,b=0, l=0, r=0))
